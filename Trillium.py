...
class Player:
    ...
    def output(self, currentRound, board, mode):
        if mode == "position":
            ...
            if currentRound < 150:
                if self.isFirst:
                    return walk_s1(self, board, currentRound, 3, -float("inf"), float("inf"))
            ...
            if self.free:
                if self.isFirst:
                    return walk_c1(self, board, currentRound, 3, -float("inf"), float("inf"))
...
def walk_s1(self, board, currentRound, depth, alpha, beta):
    ...
    if depth == 3:
        ...
        if another != ():
            b.add(True, another)
            temp = walk_s1(self, b, currentRound, 2, alpha, beta)
            if temp > value:
                value = temp
                decision = another
            alpha = max(alpha, value)
...
def walk_c1(self, board, currentRound, depth, alpha, beta):
    ...
    if depth == 3:
        ...
        if another != ():
            b.add(True, another)
            temp = walk_c1(self, b, currentRound, 2, alpha, beta)
            if temp > value:
                value = temp
                decision = another
            alpha = max(alpha, value)
