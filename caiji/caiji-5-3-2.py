...
class _Node:
    ...
    def point(self, isFirst, currentRound):
        values=[0.000,1.000,5.657,15.588,32.000,55.902,88.182,129.642,181.019,243.000,316.228,401.312,498.831,609.338,]
        this=self.board.getScore(isFirst)
        that=self.board.getScore(not isFirst)
        s=0
        for i in this:
            s+=values[i]
        for i in that:
